...
I also conducted an experiment comparing the performance of Transformer and State Space Model (specifically, Mamba) based LLM architectures for increasing sequence length via number of chunks retrieved using Retrieval Augmented Generation (RAG). The project is called "MambaRALM" and you can check it out under my portfolio or [here](https://github.com/abarton51/MambaRALM).

I also conducted an experimental study comparing the performance of Transformers and State Space Model based LLMs (Mamba in specific) for increasing sequence length via number of chunks retrieved using Retrieval Augmented Generation (RAG). The project is called "MambaRALM" and you can check it out under my portfolio or [here](https://github.com/abarton51/MambaRALM).
